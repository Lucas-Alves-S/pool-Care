...
if (isset($_POST['cadastrar'])){
    ...
    $fk = $userData['profissional_id'];
    $crud->cadastroServico($desc, $nota, $fk);
}
?>
...
<body>
  ...
  <form method="POST" class="container min-w-full min-h-screen grid">
    <div
      class="login p-4 h-auto w-80 self-center justify-self-center shadow-xl shadow-gray-400/40 rounded-lg flex flex-col justify-center">
      <div class="desc">
      ...
      <div class="nota my-6">
        <label for="nota">Nota:</label> <br />
          <input id="nota"
            ...
            type="number" name="nota" required />
      </div>
      <input
        class="text-base logar rounded-lg bg-sky-500 transition duration-400 ease-in-out hover:bg-sky-400 cursor-pointer py-2"
        value="Cadastrar" name="cadastrar" type="submit"/>
    </div>
  </form>

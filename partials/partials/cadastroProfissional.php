...
<body>
  ...
  <div class="container mx-auto h-screen flex flex-column justify-center">
    ...
    <form method="POST" class="register h-2/3  p-4 self-center justify-self-center shadow-lg shadow-gray-400/40 rounded-lg grid grid-cols-4 gap-3 grid-rows-6 md:m-0 md:ml-24 md:mr-24">
